...
typedef enum{
    ...
    CalendarCellTypeTask,
    CalendarCellTypeClass
}CalendarCellType;
...
@property (nonatomic,assign)CalendarCellType calendarType;
...
//绑定日历事件
@property (nonatomic,strong)NSArray *evenData;
...
-(void) SACalendar:(SACalendar*)calendar ScrollViewDidEndDeceleratingMonth:(int)month year:(int)year;
