...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        [col1.layer setBorderColor:TABBAR_BACKGROUND_SELECTED.CGColor];//[[UIColor colorWithRed:1 green:0 blue:0 alpha:1] CGColor]];
        [col1.layer setBorderWidth:1.0];
		col1.font = [UIFont fontWithName:@"Helvetica" size:18.0];
		col1.frame = rect;
        ...
        if(self->numRows == 0){
            ...
            col1.backgroundColor = TABBAR_BACKGROUND_SELECTED;//[UIColor redColor];
            col1.textColor = [UIColor whiteColor];
            col1.font = [UIFont boldSystemFontOfSize:18.0];
        }
