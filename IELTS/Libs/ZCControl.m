                            ...
                            Height:(CGFloat)h
{
    if(IS_IOS8)
    {
        XDFNavigationController *nav = [[XDFNavigationController alloc]initWithRootViewController:toController];
        CGRect rx = [ UIScreen mainScreen ].bounds;
        CGPoint pt = CGPointMake(rx.size.width/2.0, rx.size.height/2.0);
        [nav setFormRect:CGRectMake(pt.x-w/2.0, pt.y-h/2.0, w, h)];
        nav.navigationBarHidden = isHiddenNav;
    ...
    {
        UINavigationController *nav = [[UINavigationController alloc]initWithRootViewController:toController];
...
//        ^(void)
//        {
//            [UIView beginAnimations:@"smooth" context:nil];
//            [UIView animateWithDuration:0.1 animations:nil];
//            nav.view.superview.center = pt;
//            [UIView commitAnimations];
//        }]
    }
//    UIButton *buttonItem = [ZCControl createButtonWithFrame:CGRectMake(0, 0, 46, 22)
//                                                  ImageName:@"btn_back.png"
//                                                     Target:nav
//                                                     Action:@selector(cancellAction:)
//                                                      Title:@""];
//    
//    UIBarButtonItem *barItem = [[UIBarButtonItem alloc]initWithCustomView:buttonItem];
//    toController.navigationItem.leftBarButtonItem = barItem;
}
                      ...
                      Height:(CGFloat)height
{
    if (!IS_IOS8) {
        ...
        toController.navigationController.view.superview.frame = CGRectMake(x, y, width, height);
    }
}
...
+ (NSString *)imgTypeCatagory:(NSString *)catagory
{
    ...
    if (kStringEqual(catagory, @"听力")) {
//        imageString = @"120_listen.png";
        imageString = @"mater_hl_01.png";
    }else if (kStringEqual(catagory, @"口语")){
//        imageString = @"120_speak.png";
        imageString = @"mater_hl_02.png";
    }else if (kStringEqual(catagory, @"阅读")){
//        imageString = @"120_read.png";
        imageString = @"mater_hl_03.png";
    }else if (kStringEqual(catagory, @"写作")){
//        imageString = @"120_write.png";
        imageString = @"mater_hl_04.png";
    }else if (kStringEqual(catagory, @"词汇")){
//        imageString = @"120_Vocabular.png";
        imageString = @"mater_hl_05.png";
    }else if (kStringEqual(catagory, @"语法")){
//        imageString = @"120_grammar.png";
        imageString = @"mater_hl_06.png";
    }else if (kStringEqual(catagory, @"综合")){
//        imageString = @"120_synthetic.png";
        imageString = @"mater_hl_07.png";
    }
    return imageString;
}
